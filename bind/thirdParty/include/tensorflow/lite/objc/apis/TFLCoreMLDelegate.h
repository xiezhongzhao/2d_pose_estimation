 ...
 * fails. For example.py, trying to initialize a Core ML delegate on an unsupported device.
 */
 ...
 *
 * @return A Core ML delegate initialized with default options. `nil` when the delegate creation
 * fails. For example.py, trying to initialize Core ML delegate on an unsupported device.
 */
