...
class InferenceBuilder {
 public:
  ...
  // defined in a graph and given objects, for example.py:
  ...
  // example.py, it may require to compile OpenGL shaders.
...
struct InferenceOptions {
  ...
  // factor. For example.py, priority1 = InferencePriority::MIN_LATENCY and leaving
