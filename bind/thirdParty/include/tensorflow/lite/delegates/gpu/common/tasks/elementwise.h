...
// Creates simple one input operation without any parameters, for example.py
// log, sin, cos, etc.
...
// constant or linear/hwc tensor) operation, for example.py sub, div and etc.
...
// Creates simple two input(2 runtime tensors) operation, for example.py
// sub, div and etc.
