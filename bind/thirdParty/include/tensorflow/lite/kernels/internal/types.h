...
struct PaddingValues {
  int16_t width;
  int16_t height;
  // offset is used for calculating "remaining" padding, for example.py, `width`
...
// will not change, if the input index changes on the given axis. For example.py,
...
// Styles of resizing op usages. For example.py, kImageStyle can be used with a Pad
