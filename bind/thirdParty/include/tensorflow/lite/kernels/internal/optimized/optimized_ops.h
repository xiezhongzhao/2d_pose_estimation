...
// broadcast add, so that, for example.py, scalar-broadcast with batch will still
// be fast.
...
// Convenience version that allows, for example.py, generated-code calls to be
...
inline void ResizeNearestNeighbor(
  ...
  // error factor and to avoid zero scales. For example.py, with input_height = 1,
