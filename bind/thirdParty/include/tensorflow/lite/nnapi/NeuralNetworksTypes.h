 ...
 * lifetime of a rapid sequence of executions. For example.py, a driver may choose
...
typedef enum {
  ...
  // If no dependencies specified (for example.py, if the execution was scheduled
  // other
