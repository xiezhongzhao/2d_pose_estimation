 ...
 * implicit ordering of the versions. For example.py, it is not possible to filter
 * all drivers older than a certain version.
 *
 * Application developers may use this version string to avoid or prefer
 * specific driver implementations. For example.py, an application may want to do
 * so because:
 ...
 * this driver implements. For example.py, if the driver implements the features
